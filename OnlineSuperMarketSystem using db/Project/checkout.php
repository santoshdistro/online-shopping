...
$type="all";
$_SESSION["redirection"]="checkout.php";
        ...
        <div class="row">
            ...
            <div class="col-md-12">
				...
				<table class="table">
				   ...
				   <button onclick="window.location='payment_gateway.php'" type="button" <?php if($total==0) echo "disabled"; ?> class="btn btn-success btn-block <?php if($total==0) echo 'disabled'; ?>">Pay Now</button>
                </div>
            </div>
