...
$type="all";
$_SESSION["redirection"]="orders.php";
    ...
    <div class="container">
        ...
        <div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12">
				<h1 style="font-family: 'Ruslan Display', cursive;" align="center">Your Orders!</h1>
			</div>
            <div class="col-md-12">
				...
				<table class="table table-hover">
                   ...
                   <?php 
							...
							$o=mysqli_query($con,"select * from orders where uid='$uid' order by oid desc");
							while($order=mysqli_fetch_assoc($o))
							{
								
								echo '<tr class="clickable-row" data-href="showPurchase.php?oid='.$order["oid"].'">
									<td>#'.$order["oid"].'</td>
