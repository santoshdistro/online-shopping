...
$_SESSION["redirection"]="profile.php";
...
$uid=$_SESSION["uid"];
$user=mysqli_fetch_assoc(mysqli_query($con,"select * from users where uid='$uid'"));
?>
<!DOCTYPE html>
<html lang="en">
<!--  FONT AWESOME
    ...
    <div class="container">
        ...
        <div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12">
				<h1 style="font-family: 'Ruslan Display', cursive;" align="center">Your Profile!</h1>
			</div>
            <div class="col-md-3">
                ...
                <div class="row">
					...
					<form action="register.php" method="post">
					  <div class="form-group">
						...
						<input disabled type="text" value="<?php echo $user["fname"]; ?>" class="form-control" required placeholder="First Name" name="fname" id="fname">
					  </div>
					  <div class="form-group">
						<label for="lname">Last Name:</label>
						<input disabled type="text" value="<?php echo $user["lname"]; ?>" class="form-control" required placeholder="Last Name" name="lname" id="lname">
					  </div>
					  <div class="form-group">
						<label for="email">Email address:</label>
						<input disabled type="email" value="<?php echo $user["email"]; ?>" class="form-control" required placeholder="Email" name="email" id="email">
						
					  </div>
					  
					  <div class="form-group">
						<label for="phone">Phone/Mobile:</label>
						<input disabled type="text" value="<?php echo $user["phone"]; ?>" class="form-control" required placeholder="Phone/Mobile" name="phone" id="phone">
						
					  </div>
					  
					  <div class="form-group">
						  <label for="address">Address:</label>
						  <textarea disabled class="form-control" rows="5" required placeholder="Address" name="address" id="address"><?php echo $user["address"]; ?></textarea>
						</div>
					  
					  <div class="form-group">
						<label for="state">State:</label>
						<input disabled type="text" value="<?php echo $user["state"]; ?>" class="form-control" required placeholder="State" name="state" id="state">
					  </div>
					  <div class="form-group">
						<label for="city">City:</label>
						<input disabled type="text" value="<?php echo $user["city"]; ?>" class="form-control" required placeholder="City" name="city" id="city">
					  </div>
					  <div class="form-group">
						<label for="zip">Zip:</label>
						<input disabled type="text" value="<?php echo $user["zip"]; ?>" class="form-control" required placeholder="Zip" name="zip" id="zip">
					  </div>
