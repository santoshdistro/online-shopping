...
if(!isset($_SESSION["payment_accepted"]))
{
...
else
{
	...
	$q=mysqli_query($con,"insert into orders (uid,purchasedate,price,paymentmode) values ('$uid','$date','$total','$mode')");
	$o=mysqli_query($con,"select max(oid) as oid from orders where uid='$uid'");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a style="color:white;" href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> Cart (0)</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
				...
				<table class="table">
						...
						while($i<$count)
						{
							...
							while($product=mysqli_fetch_assoc($p))
							{
								...
								echo '<tr>
								 ...
								 $total+=$currentPrice;
								 $u=mysqli_query($con,"insert into bills (oid,pid,quantity,price) values ('$oid','$pid','$quantity','$currentPrice')");
								 $pu=mysqli_query($con,"update products set availability='$newAvailability', sold='$sold' where pid='$pid'");
							}
				   ...
				   <button onclick="window.location='index.php';" type="button"  class="btn btn-success btn-block ">Continue Shopping</button>
                </div>
            </div>
